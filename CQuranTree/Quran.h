...
namespace Quran
{
	...
	{
		private:
			std::vector<Arabic::Word> words;
			int chapterNum;
			int verseNum;

		public:
			Verse();
			Verse(std::vector<Arabic::Word>, int, int);

			std::vector<Arabic::Word> GetWords();
	...
	const std::map<Chapter::Name, int> Chapters
	{
